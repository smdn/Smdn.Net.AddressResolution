...
// Create IPNetworkProfile with address range of 192.168.2.0/24.
...
// Create IPNetworkProfile with address range of 192.168.2.0/255.255.255.0.
...
static IEnumerable<IPAddress> GenerateDHCPPoolAddresses()
  ...
  => Enumerable.Range(100, 20).Select(b => new IPAddress(new byte[] { 192, 168, 2, (byte)b }));
